...
namespace Hackaiti.Currencies.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ConnectionMultiplexer>(serviceProvider =>
            {
                ...
                var redis = ConnectionMultiplexer.Connect(apiConfig.RedisConnectionString);
            ...
            services.AddHttpClient<ICurrencyHttpClient, CurrencyHttpClient>();
        }
